...
class Wayformer(BaseModel):
    ...
    def _forward(self, inputs):
        ...
        road_pts_feats = self.relu(self.road_pts_lin(roads[:, :self.max_num_roads, :, :self.map_attr]).view(B,-1,self.d_k)) + self.map_positional_embedding
    ...
    def configure_optimizers(self):
        ...
        scheduler = torch.optim.lr_scheduler.OneCycleLR(optimizer, max_lr=0.0002, steps_per_epoch=1, epochs=150, pct_start=0.04, div_factor=25.0, final_div_factor=100,
